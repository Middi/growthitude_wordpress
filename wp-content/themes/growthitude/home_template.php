      ...
      <div class="container">
          <div class="row credi">
              ...
              <div class="col-xs-3 text-center">
                  <img class="img cred-img" src="/growthitude_wordpress/wp-content/uploads/2017/02/cred1.png" alt="">
              </div>
              <div class="col-xs-3 text-center">
                  <img class="img cred-img" src="/growthitude_wordpress/wp-content/uploads/2017/02/cred2.png" alt="">
              </div>
              <div class="col-xs-3 text-center">
                  <img class="img cred-img" src="/growthitude_wordpress/wp-content/uploads/2017/02/cred3.png" alt="">
              </div>
              <div class="col-xs-3 text-center">
                  <img class="img cred-img" src="/growthitude_wordpress/wp-content/uploads/2017/02/cred4.png" alt="">
              </div>
